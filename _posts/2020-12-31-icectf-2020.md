...
This cracked the passcode in under 10 seconds (compared to 10 minutes before) and works by doing the previous solution, but much faster through calling make_request 180 times, rather than just once per iteration of the URL list. The optimised script gets through 1729 requests before the previous one can even do 15. 
